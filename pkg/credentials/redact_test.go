...
// ---------------------------------------------------------------------------
// RedactLogLine and RedactString were removed; detection migrated to
// pkg/secretdetect (gitleaks-backed). Coverage of the new detector lives in
// pkg/secretdetect/scanner_test.go.
// ---------------------------------------------------------------------------
