...
[x] - CONTEXT: Add `repo_map` tool — lightweight AST-based codebase overview (~1K tokens) showing file paths, function signatures, and type declarations so agents understand structure before reading files. Follows Aider's approach. See SP-024.
