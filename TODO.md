...
[] - CONTEXT: Add observation masking — replace old tool outputs with placeholders after processing to prevent quadratic context accumulation. JetBrains research shows 52% cheaper and 2.6% more effective than summarization. See SP-024.
