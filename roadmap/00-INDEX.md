...
**Counts (as of 2026-07-17):** 80 shipped · 4 pending · 1 on hold.
...
| SP-114 | [Unify CLI and Steer Panel Command Execution](./SP-114-unify-command-execution.md) | 🔵 Phase 1 shipped (`ab6c975e`, 2026-07-16): `SteerCapable` interface + 31-command classification + CLI/WebUI steer allowlist. **Phase 2 pending:** `/api/command` endpoint + WebUI command input UI + output capture/routing (spec §2a–2d). |
