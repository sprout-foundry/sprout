...
| SP-139 | [Context Panel De-Necessitation](./SP-139-context-panel-de-necessitation.md) | 🟡 Phase 1 shipped (2026-09-10, `0b333b5d3` + `fb0306490` + `339cd1100`): 6 tabs → 3 (Activity merges Tools+Subagents; Tasks and Status deleted in favor of InlineTodoSummary/Costs page/status bar). Phase 2 (in-flow per-turn change summaries) and Phase 3 (Sessions relocate-or-ratify decision) scoped, unstarted. |
