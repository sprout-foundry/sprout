...
| SP-139 | [Context Panel De-Necessitation](./SP-139-context-panel-de-necessitation.md) | 🟡 Phases 1–2 shipped. Phase 1 (2026-09-10, `0b333b5d3` + `fb0306490` + `339cd1100`): 6 tabs → 3. Phase 2 (2026-09-14, `af8cdb8f5`): per-turn change strip in the chat flow — collapsed "N files changed this turn" with Review (agent-session diff buffer) and Revert (since-scoped, honest semantics); zero polling, memo'd over the capped fileEdits stream. Phase 3 (Sessions relocate-or-ratify) decision pending. |
