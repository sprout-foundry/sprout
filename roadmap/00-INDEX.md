...
| SP-131 | [Agent Creation & Event Publishing Dedup](./SP-131-agent-creation-dedup.md) | 🟢 Phases 0–5 shipped — `setupWebUIAgent` helper (P1), `PublishEvent` dedup (P2), regression tests (P3), `SafeGo` helper (P4), `captureCommandOutput` helper (P5). Phases 6–7 (webui lock boilerplate, SetWorkspaceRoot consolidation) are lower priority and deferred. |
