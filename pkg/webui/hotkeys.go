...
func sharedUniversalHotkeys() []HotkeyEntry {
	return []HotkeyEntry{
		...
		{Key: "Ctrl+Shift+5", CommandID: "split_terminal_horizontal", Description: "Split terminal horizontal"},
		{Key: "Cmd+Shift+5", CommandID: "split_terminal_horizontal", Description: "Split terminal horizontal (Mac)"},
		{Key: "Ctrl+Alt+5", CommandID: "split_terminal_vertical", Description: "Split terminal vertical"},
		{Key: "Cmd+Alt+5", CommandID: "split_terminal_vertical", Description: "Split terminal vertical (Mac)"},
		...
		{Key: "Ctrl+Shift+W", CommandID: "close_all_editors", Description: "Close all editors", Global: true},
		{Key: "Cmd+Shift+W", CommandID: "close_all_editors", Description: "Close all editors (Mac)", Global: true},
		{Key: "Ctrl+Alt+W", CommandID: "close_other_editors", Description: "Close other editors", Global: true},
		{Key: "Cmd+Alt+W", CommandID: "close_other_editors", Description: "Close other editors (Mac)", Global: true},
...
func VsCodeHotkeyConfig() *HotkeyConfig {
	editor := []HotkeyEntry{
		...
		{Key: "Ctrl+T", CommandID: "editor_workspace_symbol", Description: "Go to symbol in workspace"},
		{Key: "Cmd+T", CommandID: "editor_workspace_symbol", Description: "Go to symbol in workspace (Mac)"},
		...
		{Key: "Ctrl+Alt+R", CommandID: "editor_toggle_relative_line_numbers", Description: "Toggle relative line numbers"},
		{Key: "Cmd+Alt+R", CommandID: "editor_toggle_relative_line_numbers", Description: "Toggle relative line numbers (Mac)"},
