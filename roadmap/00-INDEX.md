...
| SP-124 | [LLM-Augmented Security Analysis](./SP-124-llm-security-analysis.md) | 🟢 Phase 1 shipped (2026-07-18) — backend `AnalyzeShellCommand` + thread-safe cache + `BrokerDecision.Analysis` plumbing. Phase 2 (WebUI dialog redesign) pending: extend approval event to carry analysis, render in dialog with visual recommendation indicator. |
