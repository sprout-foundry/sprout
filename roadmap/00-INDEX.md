...
| SP-142 | [Chat Mode Lanes — Per-Mode Chat Ownership on the Server](./SP-142-chat-mode-lanes.md) | 📋 Draft (2026-09-24) — server-side chat `mode` stamping, mode-filtered tab lists, cross-mode switch backstop, and a one-runner-per-workspace query gate with queue-behind UX. Fixes "chats don't stay in their lane" (design/code chat contamination). Not started. |
