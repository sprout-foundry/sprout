...
func sharedUniversalHotkeys() []HotkeyEntry {
	return []HotkeyEntry{
		...
		{Key: "Ctrl+Shift+W", CommandID: "close_all_editors", Description: "Close all editors"},
		{Key: "Cmd+Shift+W", CommandID: "close_all_editors", Description: "Close all editors (Mac)"},
		{Key: "Ctrl+Alt+W", CommandID: "close_other_editors", Description: "Close other editors"},
		{Key: "Cmd+Alt+W", CommandID: "close_other_editors", Description: "Close other editors (Mac)"},
