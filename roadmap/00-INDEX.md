...
| SP-132 | [WebUI API Consistency & Boilerplate Elimination](./SP-132-webui-api-consistency.md) | 🟡 Draft — 7 phases identified from systematic webui audit: method-guard dedup (134 sites), error helper consolidation, bare JSON encoding migration (183 sites), http.Error→JSON migration (377 sites), file splitting (16 files >500 lines), cs.Agent locking audit, goroutine recovery. |
