...
// --native-chat      Implemented: strips the fetch/SSE agent-turn chat
//                    transport from the bundle (shell provides it natively).
// --native-git       Implemented: strips the git client API + boot wiring
//                    from the bundle (shell provides git natively).
...
function printHelp() {
  ...
  console.log(
    "  --output <dir>         Output directory (default: dist/<mode>/)",
  );
  console.log(
    "  --api-url <url>        Foundry API base URL (runtime-configurable)",
  );
  console.log(
    "  --ws-url <url>         Foundry WebSocket URL (runtime-configurable)",
  );
  console.log(
    "  --components           Build standalone editor + terminal entries (root base)",
  );
  console.log(
    "  --native-fs            Track R: strip WASM FS/workspace ops (shell provides them natively)",
  );
  console.log(
    '  --ratify-fs            Track R (R-2w): emit the fs portion of capabilities.json as "ratified"',
  );
  console.log(
    "                         (requires --native-fs; makes the dist a shell-servable swap)",
  );
  console.log(
    "  --native-terminal      Track R: strip the terminal transport (shell provides it natively)",
  );
  console.log(
    '  --ratify-terminal      Track R (R-3): emit the terminal portion of capabilities.json as "ratified"',
  );
  console.log(
    "                         (requires --native-terminal; makes the dist a shell-servable swap)",
  );
  console.log(
    "  --native-chat          Track R: strip the fetch/SSE agent-turn chat transport (shell provides it natively)",
  );
  console.log(
    '  --ratify-chat          Track R (R-4): emit the chat portion of capabilities.json as "ratified"',
  );
  console.log(
    "                         (requires --native-chat; makes the dist a shell-servable swap)",
  );
  console.log(
    "  --native-git           Track R: strip the git client API + boot wiring (shell provides git natively)",
  );
  console.log(
    '  --ratify-git           Track R: emit the git portion of capabilities.json as "ratified"',
  );
  console.log(
    "                         (requires --native-git; makes the dist a shell-servable swap)",
  );
  ...
  console.log(
    "  If --api-url and --ws-url are NOT provided, the built application",
  );
  ...
  console.log(
    "  --native-fs         Implemented. Removes the WASM FS / workspace",
  );
  console.log(
    "                      operations from the bundle; the host shell supplies",
  );
  console.log(
    "                      them natively. Cannot be combined with --components.",
  );
  console.log(
    "  --ratify-fs       Implemented (R-2w). Marks the fs portion of",
  );
  console.log(
    '                      capabilities.json as status "ratified" (a',
  );
  console.log(
    "                      parity-proven, shell-servable swap) instead of the",
  );
  console.log(
    '                      default "seam-only". Requires --native-fs; with the',
  );
  console.log(
    "                      flag alone it fails fast (exit 1, no build).",
  );
  console.log(
    "  --native-terminal   Implemented (R-3). Removes the terminal transport",
  );
  console.log(
    "                      (PTY WebSocket + WASM terminal tier) from the bundle;",
  );
  console.log(
    "                      the host shell supplies it natively. Cannot be",
  );
  console.log("                      combined with --components.");
  console.log(
    "  --ratify-terminal   Implemented (R-3). Marks the terminal portion of",
  );
  console.log(
    '                      capabilities.json as status "ratified" (a',
  );
  ...
  console.log(
    '                      default "seam-only". Requires --native-terminal; with',
  );
  console.log(
    "                      the flag alone it fails fast (exit 1, no build).",
  );
  console.log("  --native-chat       Implemented (R-4). Removes the fetch/SSE");
  console.log(
    "                      agent-turn chat transport from the bundle; the host",
  );
  console.log(
    "                      shell supplies chat natively. Cannot be combined",
  );
  console.log("                      with --components.");
  console.log(
    "  --ratify-chat       Implemented (R-4). Marks the chat portion of",
  );
  console.log(
    '                      capabilities.json as status "ratified" (a',
  );
  ...
  console.log(
    '                      default "seam-only". Requires --native-chat; with',
  );
  console.log(
    "                      the flag alone it fails fast (exit 1, no build).",
  );
  console.log(
    "  --native-git        Implemented (R-4). Removes the git client API",
  );
  console.log(
    "                      and its boot wiring from the bundle; the host shell",
  );
  console.log(
    "                      supplies git natively. Cannot be combined with",
  );
  console.log("                      --components.");
  console.log(
    "  --ratify-git        Implemented (R-4). Marks the git portion of",
  );
  console.log(
    '                      capabilities.json as status "ratified" (a',
  );
  ...
  console.log(
    '                      default "seam-only". Requires --native-git; with',
  );
  console.log(
    "                      the flag alone it fails fast (exit 1, no build).",
  );
  console.log("  (No reserved --native-* flags remain — every --native-*");
  console.log("  portion above is implemented and additive with the others.)");
  console.log("");
  console.log(
    "  capabilities.json   Written to the output dir ONLY when a --native-*",
  );
  console.log(
    '                      flag excludes a portion (e.g. --native-fs -> "fs").',
  );
  console.log(
    "                      Absence of the file = full webui dist, nothing excluded.",
  );
  console.log(
    '                      Each excluded entry carries status "seam-only" (a build-time',
  );
  console.log(
    "                      artifact; a shell must not serve it until the parity",
  );
  console.log(
    '                      gate ratifies the swap, status "ratified").',
  );
  console.log(
    '                      Add --ratify-fs to emit the fs entry as "ratified" —',
  );
  console.log(
    "                      the R-2w parity-proven, shell-servable swap. Add",
  );
  console.log(
    "                      --ratify-terminal to emit the terminal entry as",
  );
  console.log(
    '                      "ratified" (the R-3 parity-proven, shell-servable swap).',
  );
  console.log(
    "                      Add --ratify-chat to emit the chat entry as",
  );
  console.log(
    '                      "ratified" (the R-4 parity-proven, shell-servable swap).',
  );
  console.log(
    "                      Add --ratify-git to emit the git entry as",
  );
  console.log(
    '                      "ratified" (the git parity-proven, shell-servable swap).',
  );
  console.log(
    "  Rollback            Rebuild with the flag omitted to restore the portion.",
  );
  console.log("");
  console.log("Examples:");
  console.log(
    "  node build-webui-dist.mjs                 # Build cloud-mode to dist/cloud/",
  );
  console.log(
    "  node build-webui-dist.mjs --mode local    # Build local-mode to dist/local/",
  );
  console.log("  node build-webui-dist.mjs --mode cloud --output ./release");
  console.log(
    "  node build-webui-dist.mjs --api-url https://api.example.com/api --ws-url wss://api.example.com/ws",
  );
  console.log(
    "  node build-webui-dist.mjs --native-fs     # Cloud build with WASM FS stripped",
  );
  console.log(
    "  node build-webui-dist.mjs --native-fs --ratify-fs  # fs portion ratified (shell-servable)",
  );
  console.log(
    "  node build-webui-dist.mjs --native-terminal # Cloud build with terminal transport stripped",
  );
  console.log(
    "  node build-webui-dist.mjs --native-fs --native-terminal  # additive: fs + terminal stripped",
  );
  console.log(
    "  node build-webui-dist.mjs --native-terminal --ratify-terminal  # terminal portion ratified (shell-servable)",
  );
  console.log(
    "  node build-webui-dist.mjs --native-fs --native-terminal --native-chat  # additive: fs + terminal + chat stripped",
  );
  console.log(
    "  node build-webui-dist.mjs --native-chat --ratify-chat  # chat portion ratified (shell-servable)",
  );
  console.log(
    "  node build-webui-dist.mjs --native-git  # Cloud build with git client API + boot wiring stripped",
  );
  console.log(
    "  node build-webui-dist.mjs --native-git --ratify-git  # git portion ratified (shell-servable)",
  );
  console.log(
    "  node build-webui-dist.mjs --native-fs --native-terminal --native-chat --native-git  # additive: all four portions stripped",
  );
}
...
export function parseArgs(argv) {
  ...
  for (let i = 0; i < argv.length; i++) {
    ...
    if (arg === "--mode" && i + 1 < argv.length) {
      ...
      // Track R (R-4): strip the fetch/SSE agent-turn chat transport from the
      // bundle; the shell provides chat natively. Sets
      // VITE_SPROUT_NATIVE_CHAT=1 for the Vite build (enables
      // nativeChatStubAliases in webui/vite.config.ts).
      opts.nativeChat = true;
    } else if (arg === "--ratify-chat") {
      // Track R (R-4): emit the chat portion of capabilities.json with
      // status "ratified" (a parity-proven, shell-servable swap) instead of
      // "seam-only". Requires --native-chat (validated in validateArgs).
      opts.ratifyChat = true;
    } else if (arg === "--native-git") {
      // Track R (R-4): strip the git client API + boot wiring from the bundle;
      // the shell provides git natively. Sets VITE_SPROUT_NATIVE_GIT=1 for the
      // Vite build (enables nativeGitStubAliases in webui/vite.config.ts).
      opts.nativeGit = true;
    } else if (arg === "--ratify-git") {
      // Track R (R-4): emit the git portion of capabilities.json with
      // status "ratified" (a parity-proven, shell-servable swap) instead of
      // "seam-only". Requires --native-git (validated in validateArgs).
      opts.ratifyGit = true;
...
export function validateArgs(opts) {
  ...
  for (const unknown of opts.unknownArgs) {
    errors.push(
      `Error: Unknown option '${unknown}'. Run with --help for usage.`,
    );
  }

  if (opts.nativeFs && opts.components) {
    errors.push(
      "Error: --native-fs cannot be combined with --components (standalone component entries are not the app bundle).",
    );
  }
  ...
  // Track R (R-4): same prohibition as --native-fs/--native-terminal — the
  // standalone component entries are not the app bundle, so the chat-seam
  // build cannot target them either.
  if (opts.nativeChat && opts.components) {
    errors.push(
      "Error: --native-chat cannot be combined with --components (standalone component entries are not the app bundle).",
    );
  }

  // Track R (R-4): same prohibition as --native-fs/--native-terminal/
  // --native-chat — the standalone component entries are not the app bundle,
  // so the git-seam build cannot target them either.
  if (opts.nativeGit && opts.components) {
    errors.push(
  ...
  // Track R (R-4): --ratify-chat ratifies the chat portion of a
  // --native-chat build. Meaningless without --native-chat, so it
  // fails fast like the other validators — BEFORE any build step.
  if (opts.ratifyChat && !opts.nativeChat) {
    errors.push("Error: --ratify-chat requires --native-chat.");
  }

  // Track R (R-4): --ratify-git ratifies the git portion of a --native-git
  // build. Meaningless without --native-git, so it fails fast like the other
  // validators — BEFORE any build step.
  if (opts.ratifyGit && !opts.nativeGit) {
    errors.push("Error: --ratify-git requires --native-git.");
  }
  ...
  if (
    ...
    errors.push(
      `Error: Invalid mode '${opts.mode}'. Must be 'cloud', 'local', or 'components'.`,
    );
  }
 ...
 *
 * Track R (R-4): `opts.nativeChat` adds a `chat` entry AFTER any `terminal`
 * entry (flags are additive; entry order follows the fs → terminal → chat
 * order of the code). `opts.ratifyChat` flips its status to "ratified".
 *
 * Track R (R-4): `opts.nativeGit` adds a `git` entry AFTER any `chat`
 * entry (flags are additive; entry order follows the fs → terminal → chat →
...
export function buildCapabilityManifest(opts) {
  ...
  if (opts.nativeChat) {
    const ratified = Boolean(opts.ratifyChat);
    excluded.push({
      portion: "chat",
      flag: "--native-chat",
      replacedBy: "native",
  ...
  if (opts.nativeGit) {
    const ratified = Boolean(opts.ratifyGit);
    excluded.push({
      portion: "git",
      flag: "--native-git",
      replacedBy: "native",
...
function run(command, argsList, cwd, extraEnv = {}) {
  ...
  if (result.error) {
    console.error(
      `Command failed to start: ${executable} ${argsList.join(" ")}`,
    );
  ...
  if (result.signal) {
    console.error(
      `Command terminated by signal ${result.signal}: ${executable} ${argsList.join(" ")}`,
    );
    process.exit(1);
  }
  if (result.status !== 0) {
    console.error(
      `Command failed with exit code ${result.status ?? 1}: ${executable} ${argsList.join(" ")}`,
    );
...
function cleanOutputDirectory(dir) {
  ...
  if (!resolvedDir.startsWith(repoRoot + "/")) {
    ...
    for (const dangerous of dangerousPaths) {
      ...
      if (
        resolvedDir === resolvedDangerous ||
        resolvedDir.startsWith(resolvedDangerous + "/")
      ) {
        console.error(
          `Error: Refusing to delete '${dir}' — inside protected path '${dangerous}'`,
        );
        process.exit(1);
      }
    }
  ...
  if (existsSync(dir)) {
    ...
    if (stats && stats.isSymbolicLink()) {
      console.error(
        `Error: '${dir}' is a symbolic link. Refusing to follow and delete.`,
      );
      process.exit(1);
    }
...
function copyEntry(sourceDir, targetDir, name) {
  if (!existsSync(join(sourceDir, name))) {
    console.error(
      `Error: expected entry '${name}' missing from component build`,
    );
    process.exit(1);
  }
...
function verifyWasmFiles(targetWasmDir) {
  ...
  if (!allPresent) {
    console.error("");
    console.error(
      "Error: WASM files were not successfully copied to the output directory.",
    );
...
function verifyDistLayout(outputDir) {
  ...
  const optional = [
    ...
    { path: "sw.js", desc: "Service worker" },
    {
      ...
      desc: "Track R native capability manifest (only present when a --native-* flag was used)",
    },
  ];
  ...
  if (!allRequired) {
    ...
    console.error(
      "See docs/DIST_BUNDLE_LAYOUT.md for the canonical structure.",
    );
    process.exit(1);
  }
...
function main(opts) {
  ...
  if (mode === "components") {
    ...
    console.log(
      "🔨 Building standalone components (editor + terminal, root base)...",
    );
    ...
    run(
      ...
      [
        ...
        "/",
        "--outDir",
        join("..", ".components-build"),
      ],
      webuiDir,
      { VITE_SPROUT_MODE: "cloud" },
    );
    ...
    cpSync(join(compBuild, "assets"), join(componentsDir, "assets"), {
      recursive: true,
    });
  ...
  if (mode === "cloud") {
    ...
    console.log(
      "🔨 Building React app with Vite in local mode (VITE_SPROUT_MODE=local)...",
    );
  }
  ...
  if (opts.nativeFs) {
    ...
    console.log(
      "    VITE_SPROUT_NATIVE_FS=1 (--native-fs: WASM FS stripped, shell provides it)",
    );
  }
  ...
  if (opts.nativeTerminal) {
    ...
    console.log(
      "    VITE_SPROUT_NATIVE_TERMINAL=1 (--native-terminal: terminal transport stripped, shell provides it)",
    );
  }

  // Track R (R-4): native chat — tell the frontend bundle that the
  // fetch/SSE agent-turn chat transport is provided natively by the shell
  // so the chat transport module is stubbed out of the build.
  if (opts.nativeChat) {
    buildEnv.VITE_SPROUT_NATIVE_CHAT = "1";
    console.log(
      "    VITE_SPROUT_NATIVE_CHAT=1 (--native-chat: chat transport stripped, shell provides it)",
    );
  }

  // Track R (R-4): native git — tell the frontend bundle that the git client
  // API + boot wiring is provided natively by the shell so the git client API
  // module is stubbed out of the build.
  if (opts.nativeGit) {
    buildEnv.VITE_SPROUT_NATIVE_GIT = "1";
    console.log(
      "    VITE_SPROUT_NATIVE_GIT=1 (--native-git: git client API stubbed, shell provides it)",
    );
  }
  ...
  if (opts.ratifyFs) {
    console.log(
      '    capabilities.json fs portion will be emitted as status "ratified" (--ratify-fs)',
    );
  }
  ...
  if (opts.ratifyTerminal) {
    console.log(
      '    capabilities.json terminal portion will be emitted as status "ratified" (--ratify-terminal)',
    );
  }

  // Track R (R-4): --ratify-chat marks the chat portion of
  // capabilities.json as "ratified". Like --ratify-fs/--ratify-terminal,
  // it does not change the Vite build (the bundle is identical to
  // --native-chat); it only changes the capabilities.json manifest that
  // the shell reads at serve time.
  if (opts.ratifyChat) {
    console.log(
      '    capabilities.json chat portion will be emitted as status "ratified" (--ratify-chat)',
    );
  }

  // Track R (R-4): --ratify-git marks the git portion of
  // capabilities.json as "ratified". Like --ratify-fs/--ratify-terminal/
  // --ratify-chat, it does not change the Vite build (the bundle is
  // identical to --native-git); it only changes the capabilities.json
  // manifest that the shell reads at serve time.
  if (opts.ratifyGit) {
    console.log(
      '    capabilities.json git portion will be emitted as status "ratified" (--ratify-git)',
    );
  }
