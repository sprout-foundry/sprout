...
func TestNewConfigDefaults(t *testing.T) {
	...
	assert.Equal(t, 30, cfg.APITimeouts.ConnectionTimeoutSec)
	assert.Equal(t, 60, cfg.APITimeouts.FirstChunkTimeoutSec)
	assert.Equal(t, 320, cfg.APITimeouts.ChunkTimeoutSec)
	assert.Equal(t, 600, cfg.APITimeouts.OverallTimeoutSec)
