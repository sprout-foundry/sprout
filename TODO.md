...
[] - CONTEXT: Lower `read_file` line-range limit from 10MB to 2MB — 10MB allows accidental ~2.5M token reads; 2MB is a more reasonable safety valve. See SP-024. `pkg/agent_tools/read.go`
