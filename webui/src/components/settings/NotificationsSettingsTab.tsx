  ...
  return (
    <div className="section">
      ...
      <p className="config-help" style={{ marginBottom: '12px' }}>
        Get notified when tasks complete or input is required while the Sprout
        tab is backgrounded.
      </p>
      ...
      <div className="config-item">
        ...
        {testStatus === 'blocked' && (
          <div
            ...
            style={{ color: 'var(--accent-danger, #dc3545)' }}
          >
            Browser notifications are blocked. Check your browser settings to
            allow them.
          </div>
        )}
        {testStatus === 'sent' && (
          <div
            className="config-help"
            style={{ color: 'var(--accent-success, #28a745)' }}
          >
