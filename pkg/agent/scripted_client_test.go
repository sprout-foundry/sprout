...
func TestScriptedClient_SendChatRequestStream(t *testing.T) {
	...
	_, err := client.SendChatRequestStream(context.Background(), nil, nil, "", false, callback)
	if err != nil {
...
func TestScriptedClient_RateLimitAfter(t *testing.T) {
	...
	resp1, err := client.SendChatRequest(context.Background(), nil, nil, "", false)
	if err != nil {
	...
	_, err = client.SendChatRequest(context.Background(), nil, nil, "", false)
	if err == nil {
...
func TestScriptedClientWithVision(t *testing.T) {
	...
	resp, err := client.SendVisionRequest(context.Background(), nil, nil, "", false)
	if err != nil {
...
func TestScriptedClient_VisionFallback(t *testing.T) {
	...
	resp1, err := client.SendVisionRequest(context.Background(), nil, nil, "", false)
	if err != nil {
	...
	resp2, err := client.SendChatRequest(context.Background(), nil, nil, "", false)
	if err != nil {
...
func TestScriptedClient_LastResponse(t *testing.T) {
	...
	client.SendChatRequest(context.Background(), nil, nil, "", false)
...
func TestScriptedClient_SequentialErrors(t *testing.T) {
	...
	_, err1 := client.SendChatRequest(context.Background(), nil, nil, "", false)
	if err1 == nil {
		t.Error("expected error 1")
	}

	_, err2 := client.SendChatRequest(context.Background(), nil, nil, "", false)
	if err2 == nil {
...
func TestScriptedClient_SendChatRequestStream_StreamErrorAdvancesIndex(t *testing.T) {
	...
	resp, err := client.SendChatRequestStream(context.Background(), nil, nil, "", false, callback)
	if err != nil {
...
func TestScriptedClient_SendChatRequestStream_IncludesReasoningContent(t *testing.T) {
	...
	resp, err := client.SendChatRequestStream(context.Background(), nil, nil, "", false, func(chunk, role string) {})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
