    ...
    <div className={`sprout-logo ${compact ? 'compact' : ''} ${className}`.trim()}>
      <div className="sprout-logo-mark" aria-hidden="true">
        <svg viewBox="0 0 32 32" role="img" aria-labelledby={logoTitleId}>
          ...
          {/* Background */}
          <rect className="sprout-logo-bg" x="0.75" y="0.75" width="30.5" height="30.5" rx="3" />
          {/* Code lines (base) */}
          <path
          ...
          />
          {/* Stem */}
          <path className="sprout-logo-accent" d="M16 19V7" fill="none" strokeWidth="2" strokeLinecap="round" />
          {/* Left leaf */}
          <path
          ...
          />
          {/* Right leaf */}
          <path className="sprout-logo-accent-fill" d="M16 11C18 9 21 8 23 8.5C21 9.5 18 10.5 16 13Z" opacity="0.65" />
        </svg>
      </div>
      {showWordmark ? (
