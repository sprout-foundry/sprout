...
const atomOneDark: ThemePack = {
  ...
  variables: {
    ...
    '--cm-cursor': '#528bff',
    '--cm-selection': 'rgba(62, 68, 81, 0.45)',
    '--cm-selection-match-bg': 'rgba(97, 175, 239, 0.15)',
    '--cm-selection-match-outline': 'rgba(97, 175, 239, 0.45)',
    '--cm-selection-match-main-bg': 'rgba(97, 175, 239, 0.25)',
    '--cm-selection-match-main-outline': 'rgba(97, 175, 239, 0.65)',
...
const atomOneLight: ThemePack = {
  ...
  variables: {
    ...
    '--cm-cursor': '#526fff',
    '--cm-selection': 'rgba(196, 211, 255, 0.55)',
    '--cm-selection-match-bg': 'rgba(64, 120, 242, 0.14)',
    '--cm-selection-match-outline': 'rgba(64, 120, 242, 0.5)',
    '--cm-selection-match-main-bg': 'rgba(64, 120, 242, 0.24)',
    '--cm-selection-match-main-outline': 'rgba(64, 120, 242, 0.7)',
...
const dracula: ThemePack = {
  ...
  variables: {
    ...
    '--cm-cursor': '#f8f8f2',
    '--cm-selection': 'rgba(68, 71, 90, 0.45)',
    '--cm-selection-match-bg': 'rgba(139, 233, 253, 0.12)',
    '--cm-selection-match-outline': 'rgba(139, 233, 253, 0.4)',
    '--cm-selection-match-main-bg': 'rgba(139, 233, 253, 0.22)',
    '--cm-selection-match-main-outline': 'rgba(139, 233, 253, 0.6)',
