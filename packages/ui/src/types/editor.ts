/**
 * Editor buffer management types for @sprout/ui.
 *
 * These types define the structure for managing editor buffers, panes,
 * and layout state. They are used by EditorManagerContext and related
 * editor management components.
 */
