 ...
 */
export const BINARY_FILE_PATTERN =
  /\.(png|jpe?g|gif|bmp|webp|ico|tiff?|avif|mp[34]|wav|ogg|mpg|mpeg|avi|mov|zip|tar|gz|bz2|xz|7z|rar|exe|dll|so|dylib|wasm|pdf|docx?|xlsx?|pptx?|odt|ods|odp|ttf|otf|woff2?|eot|bin|dat|db|sqlite)$/i;
