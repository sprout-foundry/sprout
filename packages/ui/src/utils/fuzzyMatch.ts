 ...
 *
 * Two strategies are tried and better score is kept:
 *   1. **Substring** – does not lower‑cased query appear anywhere?  Bonus
 *      points for prefix / word‑boundary matches.
 *   2. **Character sequence** – can each query character be found in order
 *      inside label?  Bonus points for consecutive / boundary hits.
 *
...
/**
 * Fuzzy‑search a list of items, returning best matches sorted by score.
 *
 * @param query - The user's search string.
 * @param items - Array of items to search.
 * @param getLabel - Extracts searchable string from an item.
...
/**
 * Highlight matched portions of a label string by wrapping them in
