...
| SP-143 | [Screen Kit — Interactive, Token-Driven Screens](./SP-143-screen-runtime.md) | 📋 Draft v2 (2026-09-25) — the screen kit: `design_export_tokens` grows a utility-class layer + json target; fixed scaffold assets (runtime `sprout-screens.js` with data-nav in-place navigation + states, `chrome.css` iPhone-chrome-by-default for `data-device="phone"`, base phone/desktop templates); screens are model-authored HTML from base templates (utilities + vars, data-nav anchors, declared states); `generated/screens.json` derived graph index (hash-guarded). Webui srcDoc preview gains ref rewriting to `/api/file`. Screens-first formats live in SP-140-9; SP-143 rides §9a. Not started. |
...
| SP-140-9 | [Format Rework — HTML-First Screen Tier](./SP-140-9-format-rework.md) | 🟡 Draft (2026-09-22) — parent SP-140; amends §1b/§1c, ripples into 140-2/4/5. Not started. |
